...
功能: 保存当前指令地址，并根据控制信号更新。异步复位至起始地址 0x00003000。
...
|---|---|---|---|
| PC[31:0] | 32 | I | 当前指令地址 |
| imm[15:0] | 16 | I | 16位分支指令偏移 |
| nPC_sel[1:0] | 2 | I | 下一 PC 选择信号(00=PC+4, 01=分支, 10= 跳转$ra) |
...
| MemtoReg[1:0] | 2 | O | 写回寄存器数据选择 (00=ALU结果, 01=内存数据, 10=PC+4) |
| RegWrite | 1 | O | 寄存器写使能 |
| MemWrite | 1 | O | 内存写使能 |
...
|    指令   |   `func`  |    `op`   | `RegDst<1:0>` | `ALUSrc` | `MemtoReg<1:0>` | `RegWrite` | `MemWrite` | `nPC_sel<1:0>` | `ExtOp` | `ALUctr<2:0>` |    功能描述    |
| :-----: | :-------: | :-------: | :------: | :------: | :--------: | :--------: | :--------: | :-------: | :-----: | :-----------: | :--------: |
